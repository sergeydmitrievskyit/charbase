...
export const EditFormPopup = ({
  ...
  const handleFormSubmit: SubmitHandler<CharacterEditForm> = (
    characterChanges: CharacterEditForm,
  ) => {
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          />
          {errors.name && (
            <small className="p-error text-sm">{errors.name.message}</small>
          )}
        </div>
        ...
        <div className="flex flex-wrap gap-1 justify-end pt-2 mt-6">
          ...
          <Button
            ...
            severity="success"
            disabled={
              !isDirty || Boolean(errors.name) || Boolean(errors.categories)
            }
          />
        </div>
      </form>
